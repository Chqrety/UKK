        ...
        <form method="POST" action="authentic_login.php" class="basis-1/2">
            <div class="flex flex-col px-24 py-10">
                ...
                <div class="flex flex-col mb-36">
                    <span class="font-semibold text-2xl text-primary">Selamat Datang Kembali!</span>
                    <span class="text-secondary/70">Silahkan login kedalam akun anda</span>
                </div>
                <div class="flex flex-col gap-14">
                    ...
                    <div class="flex flex-col max-w-lg gap-5">
                        <button type="submit" class="bg-ascentBlack text-white py-2 rounded-lg transition-all hover:scale-105">Login</button>
                        <div class="w-full">
                        ...
                        <button type="button" onclick="window.location.href='register.php'" class="border border-ascentBlack py-2 rounded-lg text-ascentBlack hover:bg-ascentBlack hover:text-white">Register</button>
                    </div>
                </div>
            </div>
        </form>
